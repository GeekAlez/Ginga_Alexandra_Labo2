...
builder.Services.AddDbContext<LibraryIdentityContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Ginga_Alexandra_Labo2Context") ?? throw new InvalidOperationException("Connection string 'Ginga_Alexandra_Labo2Context' not found.")));
